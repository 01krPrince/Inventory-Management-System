...
// // --- INTERNAL COMPONENT: DATE INPUT (ICON ONLY) ---
// type DateInputProps = {
//   value: string;
...
//       {/* Hidden Input: Keeps functionality but removes the DD/MM/YYYY text box */}
//       <input
//         ref={inputRef}
//         type="date"
//         value={value || ""}
...
//         style={
//           {
//             // Dynamically set hover bg color via style to match theme constant
//             // Using CSS variable logic or direct prop if needed
//           }
//         }
//         title={value || "Select Date"} // Tooltip shows the selected date
//       >
//         <CalendarIcon size={16} />
//       </button>

//       {/* Optional: Styles to ensure hover effect uses the theme color correctly */}
//       <style>{`
//         .group:hover button {
