...
// ==========================================
// SHARED LAYOUT CONTEXT (For Mobile Toggle)
// ==========================================
...
const LayoutContent: React.FC = () => {
  ...
  // Desktop sidebar reserves 80px width
  ...
  return (
    <>
      ...
      <div className="flex h-screen bg-gray-100 dark:bg-gray-900 overflow-hidden relative">
        ...
        {/* IMPORTANT: min-w-0 prevents this flex item from blowing out its container */}
        <div
        ...
        >
          ...
          <main className="flex-grow overflow-y-auto overflow-x-auto hidden-scrollbar px-5">
            {/* IMPORTANT: Added min-w-[1000px] (adjust as needed). 
                This forces the content area to remain wide on mobile, 
                triggering the horizontal scrollbar instead of squishing forms. */}
            <div className="mx-auto max-w-[1600px] min-w-[1000px] w-full pb-10 pt-0">
              {openTabs.map((tab) => {
                const TabComponent =
