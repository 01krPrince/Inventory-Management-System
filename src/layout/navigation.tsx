...
import { GridIcon, CalenderIcon, UserCircleIcon, ListIcon, TableIcon, PageIcon, PieChartIcon, BoxCubeIcon, PlugInIcon, ChevronRightIcon } from '../components/icons'; // Assume icons are exported from './icons'
...
export const navItems = [
    {
        ...
        subItems: [
            { name: "Customer", path: "/customer", pro: false },
            {
                ...
                path: "/sale-price-list-parent", // Parent path, no component directly
                pro: false,
                nestedItems: [
