...
export const navItems = [
  {
    icon: <SaleIcon className="h-5 w-5" />,
    name: 'Sale',
    subItems: [
  ...
  {
    icon: <PurchaseIcon className="h-5 w-5" />,
    name: 'Purchase',
    subItems: [
  ...
  {
    name: 'Asset',
    icon: <AssetIcon className="h-5 w-5" />,
    subItems: [
  ...
  {
    name: 'Employee',
    icon: <EmployeeIcon className="h-5 w-5" />,
    subItems: [
