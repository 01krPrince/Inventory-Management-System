...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | inventory - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for inventory - React.js Tailwind CSS Admin Dashboard Template"
      />
