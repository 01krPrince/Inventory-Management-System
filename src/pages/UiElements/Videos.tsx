...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | inventory - React.js Admin Dashboard Template"
        description="This is React.js Videos page for inventory - React.js Tailwind CSS Admin Dashboard Template"
      />
