...
interface PurchaseCreditNoteProps {
  themeColor?: string;
}

const PurchaseCreditNoteForm: React.FC<PurchaseCreditNoteProps> = ({
  themeColor = "#0f3c63",
}) => {
  // --- UI State ---
    ...
    >
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-4 space-y-2">
          ...
          <div className="grid grid-cols-12 gap-2 items-center">
            <div className="col-span-4">
              <Label>Purchase CN No</Label>
            </div>
            <div className="col-span-8">
              <Input
                value={formData.purchaseCNNo}
                onChange={(e) =>
                  handleFieldChange("purchaseCNNo", e.target.value)
                }
              />
            </div>
          </div>
        ...
        <div className="col-span-4 flex flex-col h-full justify-between">
          ...
          {/* Payment Terms & Footer (Bottom of Right Column) */}
...
export default PurchaseCreditNoteForm;
