      ...
      <div
        ...
        <div className="flex flex-col gap-8 lg:flex-row">
          ...
          <div className="flex w-full flex-col gap-2 lg:w-[400px]">
            ...
            <SplitTotalRow // in same row also add one more input field % that will be readable only if value add in discount then auto calculate % and show it
              label="Discount"
              amtRef={otherDiscAmtRef}
              taxableRef={taxableRef}
              onUpdate={calculateFinalDocAmount}
            />
            <SplitTotalRow // in same row also add one more input field % that will be readable only if value add in discount % then auto calculate value and show it
              label="Discount %"
              amtRef={otherDiscAmtRef}
              taxableRef={taxableRef}
              onUpdate={calculateFinalDocAmount}
