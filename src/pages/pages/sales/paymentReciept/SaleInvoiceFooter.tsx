...
const SaleInvoiceFooter = forwardRef<SaleInvoiceFooterRef, InvoiceFooterProps>(
  ({ currentItems, onExpenseChange }, ref) => {
    ...
    const calculateFinalDocAmount = () => {
      ...
      if (onExpenseChange) {
        const totalExpense = transport + adjustment;
      ...
      <div
        ...
        <div className="flex flex-col gap-8 lg:flex-row">
          ...
          <div className="flex w-full flex-col gap-2 lg:w-[400px]">
            <TotalRow label="Total Bill Amount" inputRef={itemValueRef} defaultValue="0.00" />
            <TotalRow label="Less Cash Discount" inputRef={discount1Ref} defaultValue="0.00" />
            <TotalRow label="Less GST TDS" inputRef={discount2Ref} defaultValue="0.00" />
            <TotalRow label="Add Delay Intrest/OC" inputRef={discount2Ref} defaultValue="0.00" />
            <TotalRow label="Net Amount" inputRef={discount2Ref} defaultValue="0.00" />
            <TotalRow label="On Account" inputRef={discount2Ref} defaultValue="0.00" />
            <TotalRow label="Total Payment" inputRef={taxableRef} defaultValue="0.00" />
            <TotalRow label="Less Bank Charges" inputRef={taxAmountRef} defaultValue="0.00" />
            <TotalRow label="Net Bank impact" inputRef={taxAmountRef} defaultValue="0.00" />
          </div>
        </div>
