      ...
      <div className="mb-4 flex justify-end">
        <div className="relative w-full max-w-xs">
          <input
            ...
            className={`w-full pl-10 pr-4 py-2 border rounded-md focus:ring-2 shadow-sm outline-none`}
            style={
              {
                borderColor: COLORS.border,
                color: COLORS.textPrimary,
                        ...
                        >
                          {isEditable ? (
                            <input
                              ...
                              className={`w-24 p-1 border rounded-md text-right focus:ring-2 outline-none`}
                              style={
                                {
        ...
        <div className="flex items-center space-x-3 w-full sm:w-auto">
          ...
          <div className="relative flex-grow">
            <select
              ...
              className={`appearance-none w-full py-2 pl-3 pr-10 border rounded-lg bg-white focus:outline-none focus:ring-2 transition duration-150`}
              style={
                {
                  borderColor: COLORS.border,
                  color: COLORS.textPrimary,
