      ...
      <div
        ...
        <div className="flex flex-col gap-8 lg:flex-row">
          ...
          <div className="flex w-full flex-col gap-2 lg:w-[400px]">
            ...
            <TotalRow label="Promo Discount" inputRef={discount1Ref} defaultValue="0.00" />
            <TotalRow label="Promo Discount 2" inputRef={discount2Ref} defaultValue="0.00" />
            <TotalRow label="Coupon Discount" inputRef={discount2Ref} defaultValue="0.00" />
