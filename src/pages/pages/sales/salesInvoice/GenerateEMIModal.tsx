  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="bg-white rounded-lg shadow-2xl w-full max-w-2xl overflow-hidden border border-gray-200">
        {/* Header */}
        <div
          className="flex justify-between items-center px-4 py-3 bg-[var(--theme-primary)] text-white"
            ...
            <div className="overflow-y-auto h-48 space-y-1">
              {schedule.length === 0 ? (
                ...
                schedule.map((row, i) => (
                  <div
                    key={i}
                    className="flex justify-between text-xs p-2 border bg-white shadow-sm"
                  >
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-6 bg-white">
            <div className="text-center space-y-4">
              <p className="text-sm text-gray-500">
                Review the schedule on the left. <br /> Click save to attach
                this EMI plan to the invoice.
              </p>
              <button
                onClick={handleSave}
