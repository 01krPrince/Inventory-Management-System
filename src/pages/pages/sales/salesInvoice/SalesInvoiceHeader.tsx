...
const HeaderButton: React.FC<HeaderButtonProps> = ({
  ...
  return (
    <button
      onClick={onClick}
      className="flex items-center gap-2 px-3 py-1 border border-[#3b769e] rounded-[3px] text-white text-xs font-medium hover:bg-white/10 hover:border-white/50 transition-colors active:bg-white/20"
    >
...
export default function SalesInvoiceHeader() {
  return (
    <div className="w-full border-t border-gray-300">
      <header className="flex flex-wrap items-center justify-between w-full bg-[#0c5888] px-4 py-1 shadow-md">
