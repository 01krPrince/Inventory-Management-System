...
const JournalVoucher: React.FC<RecieptPaymentVoucherProps> = ({ isComponent = false, onClose }) => {
    ...
    <div
      ...
      <div className="mb-6 grid grid-cols-1 gap-x-8 gap-y-3 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="space-y-2">
          <div className="flex flex-col gap-1 sm:flex-row sm:items-center">
            <div className="w-full sm:w-40">
              <Label>Pull from Expense Claim</Label>
            </div>
            <div className="flex flex-1 gap-1">
              <div className="flex w-full gap-2">
                ...
                />
                <button className="flex transform items-center gap-2 rounded-sm bg-[#0c4a75] px-5 py-0 text-sm font-bold text-white shadow-md transition-all hover:bg-[#0f3c63] active:scale-95">
                  Fill
                </button>
                <button className="flex transform items-center gap-2 rounded-sm bg-[#0c4a75] px-5 py-0 text-sm font-bold text-white shadow-md transition-all hover:bg-[#0f3c63] active:scale-95">
                  OK
