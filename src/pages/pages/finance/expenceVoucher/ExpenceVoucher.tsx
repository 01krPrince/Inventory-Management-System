...
const ExpenceVoucher: React.FC<RecieptPaymentVoucherProps> = ({ isComponent = false, onClose }) => {
    ...
    <div
      ...
      <div className="mb-6 grid grid-cols-1 gap-x-8 gap-y-3 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="grid grid-cols-12 gap-2">
            ...
            <div className="col-span-8">
              {/* <InputGroup>
                ...
                />
                <ActionBtn icon={<EditIcon size={16} />} onClick={() => setActiveModal('vendor')} />
              </InputGroup> */}
            </div>
          </div>
        ...
        <div className="space-y-2">
          <div className="flex flex-col gap-1 sm:flex-row sm:items-center">
            <div className="w-full sm:w-40">
              <Label>Reversal Voucher Type</Label>
            </div>
            <div className="flex flex-1 gap-1">
              <div className="w-full">
                <Dropdown
          ...
          <div className="flex flex-col gap-1 sm:flex-row sm:items-center">
            <div className="w-full sm:w-40">
              <Label>Reversal Voucher No</Label>
            </div>
            <div className="flex flex-1 gap-1">
              <div className="w-full">
                <Dropdown
